...
RSpec.configure do |config|
  config.before(:each) do
    ...
    stub_request(:delete, "http://test.cloudant.com/_session").
      with(:headers   => {'Accept'=>'*/*', 'Content-Type'=>'application/json', 'Cookie'=>'AuthSession=yWOGYbkliQXULjhSTrVgtue0HmAnoCfdJIEvMZxBKs1FDwzqRcpPaN_0eskojE; Version=1; Expires=Tue, 27-Sep-2016 06:35:33 GMT; Max-Age=86400; Path=/; HttpOnly; Secure', 'User-Agent'=>'Ruby'},
    ...
    stub_request(:put, "http://test.cloudant.com/test/_design/status").
      with(:body => "{\"views\":{},\"language\":\"javascript\"}",
           :headers => {'Accept'=>'*/*', 'Content-Type'=>'application/json', 'Cookie'=>'AuthSession=yWOGYbkliQXULjhSTrVgtue0HmAnoCfdJIEvMZxBKs1FDwzqRcpPaN_0eskojE; Version=1; Expires=Tue, 27-Sep-2016 06:35:33 GMT; Max-Age=86400; Path=/; HttpOnly; Secure', 'User-Agent'=>'Ruby'}).
      to_return(:status => 200, :body => "{\"ok\":true,\"id\":\"_design/status\",\"rev\":\"45-13153ec6708f15faa5818a285cda35c6\"}", :headers => {})
